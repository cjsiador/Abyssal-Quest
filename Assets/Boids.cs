...
{
    private List<Vector3> m_NearBoids;
    private FlockManager m_BelongingFlock;
    private Rigidbody m_rigidbody;

    [SerializeField] private float m_MovementSpeed;
    [SerializeField] private float m_NearbyBoidsRadius;
    ...
    private void CalculateSeperationRule()
    {
        ...
        var nearbyBoids = Physics.OverlapSphere(transform.position, m_NearbyBoidsRadius);

        foreach (var col in nearbyBoids)
        {
